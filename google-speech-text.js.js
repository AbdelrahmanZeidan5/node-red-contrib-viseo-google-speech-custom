...
const input = (RED, node, data, config) => {
    ...
    if (api === "stt") {
        ...
        if (config.alternativeLanguageCodes) {
            let alternativeLanguagesArray = config.alternativeLanguageCodes.split(", ");
            parameters.config.alternativeLanguageCodes =  alternativeLanguagesArray;
        }
